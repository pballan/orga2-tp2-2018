/* efectoBayer.c — wrapper para ARM NEON (modificado de x86 original) */
#include <stdio.h>
#include <string.h>

#include "../tp2.h"

void efectoBayer_neon (unsigned char *src, unsigned char *dst, int cols, int filas,
...
{
    efectoBayer_fn_t *efectoBayer = SWITCH_C_ASM ( config, efectoBayer_c, efectoBayer_neon ) ;
