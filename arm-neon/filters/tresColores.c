/* tresColores.c — wrapper para ARM NEON (modificado de x86 original) */
#include <stdio.h>
#include <string.h>

#include "../tp2.h"

void tresColores_neon (unsigned char *src, unsigned char *dst, int width, int height,
...
{
    tresColores_fn_t *tresColores = SWITCH_C_ASM( config, tresColores_c, tresColores_neon );
