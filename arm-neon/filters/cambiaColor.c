/* cambiaColor.c — wrapper para ARM NEON (modificado de x86 original) */
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
void cambiaColor_neon (unsigned char *src, unsigned char *dst, int cols, int filas,
...
{
    cambiaColor_fn_t *cambiaColor = SWITCH_C_ASM ( config, cambiaColor_c, cambiaColor_neon ) ;
