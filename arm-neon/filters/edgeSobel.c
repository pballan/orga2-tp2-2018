/* edgeSobel.c — wrapper para ARM NEON (modificado de x86 original) */
#include <stdio.h>
#include <string.h>

#include "../tp2.h"

void edgeSobel_neon (unsigned char *src, unsigned char *dst, int cols, int filas,
...
{
    edgeSobel_fn_t *edgeSobel = SWITCH_C_ASM ( config, edgeSobel_c, edgeSobel_neon ) ;
